...
@section('content')
    ...
    <form method="post" action="{{ route('appointment.store') }}" enctype="multipart/form-data" autocomplete="off" id="submit-appointment-form">
        @csrf
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="container">
                                ...
                                <div class="col-md-12">
                                    <h5 class="text-center"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" style=" vertical-align: top; margin-right: 6px; color: green; " fill="currentColor" class="bi bi-check2-square" viewBox="0 0 16 16">
                                      <path d="M3 14.5A1.5 1.5 0 0 1 1.5 13V3A1.5 1.5 0 0 1 3 1.5h8a.5.5 0 0 1 0 1H3a.5.5 0 0 0-.5.5v10a.5.5 0 0 0 .5.5h10a.5.5 0 0 0 .5-.5V8a.5.5 0 0 1 1 0v5a1.5 1.5 0 0 1-1.5 1.5H3z"/>
                                      <path d="m8.354 10.354 7-7a.5.5 0 0 0-.708-.708L8 9.293 5.354 6.646a.5.5 0 1 0-.708.708l3 3a.5.5 0 0 0 .708 0z"/>
                                    </svg>Choose your barber
                ...
                <div class="card mb-4 shadow-none border-0 rounded-0">
                    ...
                    <div class="card-body" id="appsumcardbody">
                        ...
                        <div class="container-summ">
                            <h5>Appointment Start : <span id="appointment_start"></span></h5>
                            <h5>Appointment End : <span id="appointment_end"></span></h5>
                            <h5>Time Duration : <span id="total_duration"></span></h5>
                            <h5>Barber : <span id="barber_name"></span></h5>
                            <hr>
                    ...
                    <div class="card-footer bg-transparent text-right">
                        <button class="btn btn-primary" id="submit-appointment">Make Appointment</button>
                    </div>
                </div>
            </div>
        </div>
...
@section('scripts')
    ...
    <script>
        ...
        function changeBranch() {
            ...
            let appointment_at = $('#appointment_at').val();
            ...
            if (branch != '') {
                ...
                $.get(`{{ url('appointment/barber') }}/${$('#appointment_at').val()}/${find.id}`).then(res => {

                        appendBarber(res.barbers);
...
$(document).ready(function() {
  $('#submit-appointment').click(function(event) { // add the event parameter
    ...
    $.ajax({
      url: '/check-overlapping-appointment',
      type: 'POST',
      data: {
