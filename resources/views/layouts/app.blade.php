...
<head>
    ...
    <style>
        body{
            background: #000000; /*Reset Password background*/
        }
        .login-img {
...
/*            background: rgba(209, 209, 209, 0.15);*/
        ...
        .btn-login:hover {
            color: #ffffff;
            background: #d5a877;
            box-shadow: 0 1rem 2rem hsl(0 0% 0% / 30%);
        }
...
<body onload="loadAnnouncement()">
    <div id="app">
        <main class="vh-100 d-flex align-items-center">
            @yield('content') </main> </div> <div class="modal fade"
             id="agreementModal" data-bs-backdrop="static"
             data-bs-keyboard="false" tabindex="-1"
             aria-labelledby="staticBackdropLabel" aria-hidden="true"> <div
             class="modal-dialog"> <div class="modal-content"> <div
             class="modal-body text-center"> <div class="image-wrapper"
             style="max-height: 350px;"> <svg
             xmlns="http://www.w3.org/2000/svg" data-name="Layer 1"
             width="405.94938" height="350" viewBox="0 0 405.94938 611.97003"
             ...
             transform="translate(-396.87063 -155.33997)" fill="#f0f0f0" />
             <path
             ...
             transform="translate(-396.87063 -155.33997)" fill="#fff" />
             <path
             ...
             transform="translate(-396.87063 -155.33997)" fill="#d19f68" />
             <path
             ...
             transform="translate(-396.87063 -155.33997)" fill="#d19f68" />
             <polygon points="285.224 587.176 275.389 590.416 258.211 554.026
             272.726 549.244 285.224 587.176" fill="#9f616a" /> <path
             ...
             transform="translate(-396.87063 -155.33997)" fill="#2f2e41" />
             <polygon points="192.004 595.731 181.65 595.73 176.724 555.792
             192.006 555.793 192.004 595.731" fill="#9f616a" /> <path
             ...
             transform="translate(-396.87063 -155.33997)" fill="#9f616a" />
             <path
             ...
             transform="translate(-396.87063 -155.33997)" fill="#d19f68" />
             <circle cx="599.59286" cy="406.34644" r="19.25073"
             transform="translate(-294.42147 777.76748) rotate
             (-80.78251)" fill="#9f616a" /> <path
             ...
             transform="translate(-396.87063 -155.33997)" fill="#ccc" />
             <path
             ...
             transform="translate(-396.87063 -155.33997)" fill="#fff" />
             </svg> </div> <p style="font-family: "Trirong", serif; ">By
             continuing to use the <span style="color: #704F32; font-weight: bold;:
             ">Appointment Booking System</span>, you agree to the <span
             style="color: #704F32; font-weight: bold;">Celebrity Mens
             Barbershop Data Privacy Statement</span></p> <button
             type="button" class="btn btn-secondary"
             data-bs-dismiss="modal">Agree</button> </div> </div> </div>
             </div>
