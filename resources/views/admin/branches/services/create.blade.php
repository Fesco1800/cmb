...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="d-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Add services to "{{ $branch->branch_name }}"</h1>
    ...
    <div class="row justify-content-center ">
        <div class="col-lg-6">
            <div class="card mb-4 shadow-none border-0 rounded-0">
                ...
                <div class="card-body" id="createBranchService">
                    <form class="row g-3" method="post" action="{{ route('branch.services.store', $branch) }}" enctype="multipart/form-data" autocomplete="off">
                        @csrf
                        ...
                        <div class="col-6 mt-3">
                            ...
                            <select class="form-control rounded-0" name="minutes">
                        ...
                        <div class="col-6 mt-3">
                            ...
                            <input type="number" class="form-control rounded-0" name="service_price">
                        </div>
                        <div class="col-12 mt-3">
                            <label for="avatar" class="form-label">Service Details</label>
                            <textarea type="text" class="form-control rounded-0" name="service_detail"> </textarea>
                        </div>
                        <div class="col-12 mt-3">
