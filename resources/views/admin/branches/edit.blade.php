...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="d-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">{{ $branch->branch_name }}</h1>
    ...
    <div class="row justify-content-center ">
        <div class="col-lg-6">
            <div class="card mb-4 shadow-none border-0 rounded-0">
                ...
                <div class="card-body" id="editBranch">
                    <form class="row g-3" method="post" action="{{ route('branch.update',$branch) }}" enctype="multipart/form-data" autocomplete="off">
                        @csrf
                        <div class="col-6 mt-3">
                            <label for="price" class="form-label">Branch Name<strong class="text-danger"> * </strong> </label>
                            <input type="text" class="form-control rounded-0" value="{{ $branch->branch_name }}" name="branch_name">
                        </div>
                        <div class="col-6 mt-3">
                            <label for="avatar" class="form-label">Location</label>
                            <input type="text" class="form-control rounded-0" value="{{ $branch->branch_location }}" name="branch_location">
                        </div>
                        <div class="col-6 mt-3">
                            <label for="avatar" class="form-label">Contact No.</label>
                            <input type="number" class="form-control rounded-0" value="{{ $branch->branch_contact }}" name="branch_contact">
                        </div>
                        <div class="col-6 mt-3">
                            <label for="avatar" class="form-label">Branch Image</label>
                            <input type="file" class="form-control rounded-0" value="{{ $branch->branch_img }}" name="branch_img">
                        </div>
                        <div class="col-12 mt-3">
                            <label for="price" class="form-label">Details<strong class="text-danger"> * </strong> </label>
                            <textarea type="text" class="form-control rounded-0" value="{{ $branch->branch_details }}" name="branch_details" rows="4"> {{ $branch->branch_details }}</textarea>
                        </div>
                        <div class="col-12 mt-3">
                            <label for="price" class="form-label">Branch Google Map Link<strong class="text-danger"> * </strong> </label>
                            <input type="text" class="form-control" name="google_link" value="{{ $details->google_link ?? null }}">
                        </div>
                        <div class="col-6 mt-3">
                        ...
                        <div class="col-6 mt-3">
                            ...
                            <input type="text" class="form-control rounded-0" value="{{ $branch->branch_open }}" name="branch_open">
                        </div>
                        <div class="col-6 mt-3">
                            <label for="price" class="form-label">Upto<strong class="text-danger"> * </strong> </label>
                            <input type="text" class="form-control rounded-0" value="{{ $branch->branch_close  }}"name="branch_close">
                        </div>
                        <div class="col-12 mt-3">
